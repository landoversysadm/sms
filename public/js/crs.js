...
!(function (a, n) {
  ...
  const a = function () {
    l = s;
    for (let a = document.getElementsByClassName('crs-country'), n = 0; n < a.length; n++) e(a[n]);
  };
  var e = function (a) {
    if (a.getAttribute('data-crs-loaded') !== 'true') {
      a.length = 0;
      const n = a.getAttribute('data-default-option');
      const e = n || 'Select country';
      const i = a.getAttribute('data-show-default-option');
      m = i === null || i === 'true';
      const r = a.getAttribute('data-default-value');
      const o = a.getAttribute('data-value');
      let l = 0;
      m && (a.options[0] = new Option(e, '')), B();
      const t = b(a);
      for (let s = 0; s < t.length; s++) {
        let u = o === 'shortcode' || o === '2-char' ? t[s][1] : t[s][0];
        t[s][4] && (u = ''),
        (a.options[a.length] = new Option(t[s][0], u)),
        r != null && r === u && ((l = s), m && l++);
      }
      a.selectedIndex = l;
      const d = a.getAttribute('data-region-id');
      if (d) {
        ...
        if (h) {
          if (
            ...
            r !== null && a.selectedIndex > 0)
          ) {
            c(a, h);
            const S = h.getAttribute('data-default-value');
            const A = h.getAttribute('data-value') === 'shortcode';
            if (S !== null) {
              const g = t[m ? a.selectedIndex - 1 : a.selectedIndex][3];
              k(h, g, S, A);
            }
          } else !1 === m && c(a, h);
  ...
  var M = function (a) {
    const n = a.getAttribute('data-blank-option');
    const e = n || '-';
    const i = a.getAttribute('data-show-default-option');
    (h = i === null || i === 'true'),
    (a.length = 0),
  ...
  var B = function () {
    for (let a = 0; a < l.length; a++) {
      for (
        var n = { hasShortcodes: /~/.test(l[a][2]), regions: [] }, e = l[a][2].split('|'), i = 0;
        i < e.length;
        i++
      ) {
        const r = e[i].split('~');
  ...
  var k = function (a, n, e, i) {
    for (let r = 0; r < n.regions.length; r++) {
  ...
  var c = function (a, n) {
    const e = m ? a.selectedIndex - 1 : a.selectedIndex;
    const i = n.getAttribute('data-default-option');
    const r = n.getAttribute('data-value');
    const o = i || 'Select region';
    if (a.value === '') M(n);
    else {
      (n.length = 0), h && (n.options[0] = new Option(o, ''));
      const l = b(a)[e][3];
      const t = r === 'shortcode' && l.hasShortcodes;
      const s = t ? 1 : 0;
      l.regions.sort((a, n) => {
        const e = a[s].toLowerCase();
        const i = n[s].toLowerCase();
        return e < i ? -1 : i < e ? 1 : 0;
      });
      for (let u = 0; u < l.regions.length; u++) {
        const d = t ? l.regions[u][1] : l.regions[u][0];
  ...
  var b = function (a) {
    const n = a.getAttribute('data-whitelist');
    const e = a.getAttribute('data-blacklist');
    const i = a.getAttribute('data-preferred');
    const r = a.getAttribute('data-preferred-delim');
    let o = l;
    return (
      (n || e)
        && (o = (function (a) {
          const n = `${a.whitelist}|${a.blacklist}`;
          let e = 0;
          if (!t.hasOwnProperty(n)) {
            if (((t[n] = []), a.whitelist)) {
              const i = a.whitelist.split(',');
              for (e = 0; e < s.length; e++) i.indexOf(s[e][1]) !== -1 && t[n].push(e);
            } else if (a.blacklist) {
              const r = a.blacklist.split(',');
              for (e = 0; e < s.length; e++) r.indexOf(s[e][1]) === -1 && t[n].push(e);
            }
          }
          const o = [];
  ...
  var u = function (a, n, e) {
    const i = n.split(',').reverse();
    const r = {};
    let o = !1;
    const l = a.filter(a => i.indexOf(a[1]) === -1 || ((r[a[1]] = a), !(o = !0)));
    o && e && l.unshift([e, '', '', {}, !0]);
  ...
  return (
    (function (n, e) {
      ...
      const l = r.addEventListener ? 'addEventListener' : 'attachEvent';
      const t = r.addEventListener ? 'removeEventListener' : 'detachEvent';
      const s = r.addEventListener ? '' : 'on';
      var u = function (a) {
        (a.type == 'readystatechange' && r.readyState != 'complete')
          || ((a.type == 'load' ? n : r)[t](s + a.type, u, !1),
      ...
      if (r.readyState == 'complete') e.call(n, 'lazy');
      else {
