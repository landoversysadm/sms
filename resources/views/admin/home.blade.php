    ...
    <div id="app">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-white fixed-top" id="mainNav">
                ...
                <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
                    ...
                    <li class="nav-item" data-toggle="tooltip" data-placement="right" title="">
                    <router-link class="nav-link"  to="/admin/student">
                    ...
                    <li class="nav-item" data-toggle="tooltip" data-placement="right" title="">
                      <router-link class="nav-link" to="/admin/faculties">
                    ...
                    <li class="nav-item" data-toggle="tooltip" data-placement="right" title="">
                        <router-link class="nav-link"  to="/admin/instructors">
                            <i class="fa fa-fw  icon-users-1"></i>
                    ...
                    <li class="nav-item" data-toggle="tooltip" data-placement="right" title="">
                    <router-link class="nav-link"  to="/admin/assessment">
